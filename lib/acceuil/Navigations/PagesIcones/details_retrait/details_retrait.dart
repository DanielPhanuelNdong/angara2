                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [Text('Montant'), Text('XAF XXXXXX')],
                          ),
                      
                          const Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [Text('Montant facturé'), Text('XAF XXXXXX')],
                          ),
                      
                          const Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [Text('Montant débité'), Text('XAF XXXXXX')],
                          ),
                      
                          const Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [Text('Généré le'), Text('23/12/2022')],
                          ),
                      
                          const Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [Text('Expire dans'), Text('11h 22min')],
                          ),
