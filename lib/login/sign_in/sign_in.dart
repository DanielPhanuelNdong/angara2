          ...
          if (state is RegisterSuccessState) {
            ...
            if (register != null) {
              if (register.head == false) {
                ...
                final soldewallet = register.body?.wallet?.soldewallet;
                ...
                if (soldewallet != null) {
                  await prefs.setString('soldewallet', soldewallet);
                } else {
                  await prefs.remove('soldewallet');
                }
                if (nomsutilis != null) {
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        if (value!.isEmpty ||
                          ...
                          setState(() {
                            data3['login'] = Email_Controller.text;
                          });
                          return null;
                        }
                      },
                          ...
                          onTap: () async {
                            if (formKey.currentState!.validate()) {
                              context.read<BlocBloc>().add(
                                  registerDataEvent(data: data3, url: url3));
                              // context
                              //     .read<BlocBloc>()
                              //     .add(SendMessageEvent(message: data));
                            }
                          },
                          child: Container(
                            height: 42,
