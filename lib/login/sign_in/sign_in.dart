...
import 'package:wiso_cash/features/bloc/data/repositories/index.dart';
          ...
          child: BlocListener<BlocBloc, BlocState>(
            listener: (context, state) async {
              if (state is RegisterSuccessState) {
                ...
                String? logincompte =
                    register?.body?.connexion?.logincompte ?? '';
                if (register != null) {
                  if (register.head == false &&
                      logincompte != Email_Controller.text) {
                    ...
                    final intitulewallet =
                        register.body?.wallet?.intitulewallet;
